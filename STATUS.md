...
- [x] Hotfix convite advogado local em 2026-06-05: `inviteUserByEmail` agora envia `redirectTo` configuravel por `LAWYER_INVITE_REDIRECT_URL` (padrao `https://advogado20admin.vercel.app/primeiro-acesso`) para nao cair no Site URL `localhost:3000` do Supabase. Gate: `npm run typecheck` exit 0. Pendente: publicar e reenviar convite expirado.
